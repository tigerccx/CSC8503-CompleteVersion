...
Vector4 NCL::Maths::Quaternion::ToVector4() const
{
...
Quaternion NCL::Maths::Quaternion::Between(const Quaternion& from, const Quaternion& to)
{
	Quaternion q;
	Vector4 v0 = from.ToVector4();
	Vector4 v1 = to.ToVector4();
	Vector4 a = Vector3::Cross(v0, v1);
	q.x = a.x;
	q.y = a.y;
	q.z = a.z;
	q.w = sqrt((v0.LengthSquared() * v1.LengthSquared())) + Vector4::Dot(v0, v1);
	q.Normalise();
	return q;
}
