...
Vector3 NCL::Maths::Matrix3::Solve(const Matrix3 mat, const Vector3& vec)
{
	Matrix4 mat4 = Matrix4(mat);
	Vector4 vec4 = Vector4(vec, 1);
	Vector4 vecRet = Matrix4::Solve(mat4, vec4);
	Vector3 vecRet3 = Vector3(vecRet.x, vecRet.y, vecRet.z);
	return vecRet3;
}
